export SYSTEM_TEST_PLUGINS_DEPS=com.atex.plugins:carousel-plugin:1.0:contentdata,com.atex.plugins:gui-language-sv-plugin:10.4.1:contentdata,com.atex.plugins:gui-language-sv-plugin:10.4.1:activate-contentdata,com.polopoly.test.nitro-dist:ws-adapter-test-plugin:local/pom.xml,com.polopoly.test.nitro-dist:ws-adapter-test-plugin:local/pom.xml:contentdata
